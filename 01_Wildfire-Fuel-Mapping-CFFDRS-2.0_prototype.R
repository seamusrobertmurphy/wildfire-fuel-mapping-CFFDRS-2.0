...
vri_ok_2020 = vri_ok_2020 %>% dplyr::mutate(fuel_C3 = case_when(
  BCLCS_LV_1=="V" & BCLCS_LV_2=="N" & is.na(SPEC_CD_1) & is.na(HRVSTDT) & is.na(SPEC_CD_1) & HRVSTDT <=19950000 & BEC_ZONE=="SWB" |
    BCLCS_LV_1=="V" & BCLCS_LV_5=="N" is.na(HRVSTDT) & HRVSTDT <=19950000 & !is.na(SPEC_CD_1) & BEC_ZONE=="ESSF" |
    BCLCS_LV_1=="V" & BCLCS_LV_5=="N" is.na(HRVSTDT) & HRVSTDT <=19950000 & !is.na(SPEC_CD_1) & BEC_ZONE=="MS" |
    BCLCS_LV_1=="V" & BCLCS_LV_5=="N" is.na(HRVSTDT) & HRVSTDT <=19950000 & !is.na(SPEC_CD_1) & BEC_ZONE=="SBS" |
    ...
    BCLCS_LV_1=="V" & BCLCS_LV_2=="T" SPEC_CD_1=="B" & SPEC_PCT_1 >=80 & BCLCS_LV_5=="OP" |
    BCLCS_LV_1=="V" & BCLCS_LV_2=="T" SPEC_CD_1== "BL" & SPEC_PCT_1 >=80 & BCLCS_LV_5=="OP" |
