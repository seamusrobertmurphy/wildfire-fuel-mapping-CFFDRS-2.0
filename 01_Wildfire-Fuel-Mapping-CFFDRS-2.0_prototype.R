...
vri_ok_2020 = vri_ok_2020 %>% dplyr::mutate(fuel_C5 = case_when(
  BCLCS_LV_1=="V" & BCLCS_LV_2=="N" & is.na(SPEC_CD_1) & HRVSTDT<19950000 & BEC_ZONE=="ICH" & BEC_SZONE=="w*" |
    ...
    BCLCS_LV_1=="V" & BCLCS_LV_2=="T" & SPEC_PCT_1>80 & SPEC_CD_1=="PJ" & HRVSTDT<20130000 & PROJ_HT_1>12 & CR_CLOSURE<40 & BEC_ZONE=="ICH" ||
    
    BCLCS_LV_1=="V" & BCLCS_LV_2=="T" & SPEC_PCT_1>80 & SPEC_CD_1=="P" |
