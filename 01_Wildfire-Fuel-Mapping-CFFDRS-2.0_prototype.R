...
vri_ok_2020 = vri_ok_2020 %>% dplyr::mutate(fuel_C3 = case_when(
  BCLCS_LV_1=="V" & BCLCS_LV_2=="N" & is.na(SPEC_CD_1) & is.na(HRVSTDT) & is.na(SPEC_CD_1) & HRVSTDT <=19950000 & BEC_ZONE=="SWB" |
    ...
    ###############
    BCLCS_LV_1=="V" & BCLCS_LV_2=="T" & SPEC_PCT_1>80 & SPEC_CD_1=="PL" & HRVSTDT<=2013000 & PROJ_HT_1<=12 & PROJ_HT_1 >=4 & SPEC_CD_2=="S*" &  =="DE" & "LIVE_STEMS", "DEAD_STEMS",  <  |
    BCLCS_LV_1=="V" & BCLCS_LV_2=="T" & SPEC_PCT_1>80 & SPEC_CD_1=="PL" & is.na(HRVSTDT) & PROJ_HT_1<=12 & PROJ_HT_1 >=4 & SPEC_CD_2=="S*" & N_LOG_DIST=="IBM" & N_LOG_DATE >=20150000 & BCLCS_LV_5=="OP" & DEAD_PCT < 25 |
    BCLCS_LV_1=="V" & BCLCS_LV_2=="T" & SPEC_PCT_1>80 & SPEC_CD_1=="PL" & HRVSTDT<=2013000 & PROJ_HT_1<=12 & PROJ_HT_1 >=4 & SPEC_CD_2=="B*" & N_LOG_DIST=="IBM" & N_LOG_DATE >=20150000 & BCLCS_LV_5=="OP" & DEAD_PCT < 25 |
    BCLCS_LV_1=="V" & BCLCS_LV_2=="T" & SPEC_PCT_1>80 & SPEC_CD_1=="PL" & is.na(HRVSTDT) & PROJ_HT_1<=12 & PROJ_HT_1 >=4 & SPEC_CD_2=="B*" & N_LOG_DIST=="IBM" & N_LOG_DATE >=20150000 & BCLCS_LV_5=="OP" & DEAD_PCT < 25 |
